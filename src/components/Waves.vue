	...
	mounted: function() {
		class Layer {
			constructor(selector) {                         
				this.canvas = document.querySelector(selector)   //create new Canvas element
		...
		class Mesh {
			...
			renderTriangles(ctx) {
				this.triangles.forEach(t => {
					...
					ctx.strokeStyle = `rgb( ${red  - 3}, ${green - 3}, ${blue  - 3})`
